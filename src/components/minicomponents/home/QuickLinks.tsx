...
const QuickLinks: React.FC = () => {
  ...
  return (
    <section
      className="w-full py-8 px-4 md:px-6 lg:px-8 relative overflow-hidden"
      style={{
        backgroundColor: "#fff",
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="w-16 md:w-20 h-1 bg-yellow-500 mx-auto mb-4 md:mb-6"></div>
          <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-gray-900 mb-2">
            Quick Links
          </h2>
        </div>

        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 w-full items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {links.map((link) => (
                <a
                  key={link.title}
                  href={link.href}
                  className="group relative rounded-xl p-6 md:p-8 hover:shadow-xl hover:border-yellow-200 transition-all duration-300"
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-12 md:w-14 h-12 md:h-14 bg-red-800 rounded-lg flex items-center justify-center mb-3 md:mb-4 group-hover:bg-red-700 transition-colors duration-300">
                    ...
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 md:mb-3 group-hover:text-red-800 transition-colors duration-300">
                      {link.title}
                    </h3>
                    ...
                    {/* Arrow Icon */}
                    <div className="flex items-center text-red-800 font-medium text-sm md:text-base group-hover:text-red-700 transition-colors duration-300">
                      Learn More
                      <ArrowRight
                        size={16}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100">
              <div className="flex items-center justify-between mb-4 md:mb-6">
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={prevSlide}
                    className="w-10 h-10 md:w-12 md:h-12 bg-gray-100 hover:bg-red-800 hover:text-white text-gray-600 rounded-full flex items-center justify-center transition-all duration-300"
                  >
                    <ChevronLeft size={18} />
                  </button>
                  <button
...
/>
                ...
                <div className="w-full h-64 md:h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center">
                  <div className="text-center">
                    <BookOpen
                      size={40}
                      className="text-gray-400 mx-auto mb-3 md:mb-4"
                    />
      ...
      {showModal && selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute -top-4 -right-4 w-10 h-10 md:w-12 md:h-12 bg-red-800 hover:bg-red-700 text-white rounded-full flex items-center justify-center transition-colors duration-300 shadow-lg"
            >
              <X size={20} />
            </button>
          </div>
