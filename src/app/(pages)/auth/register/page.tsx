...
export default function AlumniRegisterPage() {
  ...
  return (
     <div className="flex-1 min-h-0 flex flex-col md:flex-row bg-gradient-to-br from-blue-50 to-gray-100">
      {/* Left 40%: Carousel */}
     <div className="md:w-2/5 w-full flex-1 flex items-center justify-center bg-white relative overflow-hidden">
        <motion.div
          key={currentImage}
      ...
      {/* Right 60%: Form */}
           <div className="md:w-3/5 w-full flex-1 flex items-center justify-center py-12 px-4">
        <motion.div
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Year of Joining (for BU Employees)</FormLabel>
                      <FormControl>
                        <div className="relative">
                          <Building2 className="absolute left-3 top-3 text-blue-400 w-5 h-5" />
                          <Input
